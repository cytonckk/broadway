...
const ERA_CONTENT = [
{
  ...
  why:"",
  body:[
    `Let’s rewind the time. Before Broadway became Broadway, New York theater was just gigs hopping from town to town. There was no theater district, no Times Square, and obviously no gigantic Wicked billboard. Actors usually traveled from place to place instead. Wherever had an empty venue, that would be the theater for the night.`,
    `New York eventually got the John Street Theatre in 1767, the city’s first permanent playhouse. John Street was important, but it was basically a wooden shack; the Park Theatre was a much bigger upgrade and more important to New York theater history. When the Park opened in 1798, it had virtually no competition. The building could hold around two thousand people and actually looked like the kind of grand urban theater similar to what we have today.`,
    ...
    `Shakespeare was everywhere. Audiences watched Hamlet, Macbeth, Richard III, you name it. But, there were no musical numbers, nobody was dramatically belting on stage for three hours. The Broadway musical that we imagine today did not exist yet, and a night at the theater mostly meant spoken drama, comedy, and some music if you are lucky.`,
    `The audience interests me more than the plays, though.`,
    `Wealthy New Yorkers sat in private boxes while working people occupied the pit and cheaper galleries. The rich still got the good seats. But at least everyone was inside the same building, looking at the same actors and was the same audience.`,
...
},
{
  ...
  why:"",
  body:[
    `By 1849, the mixed audience of the Park Theatre era was already starting to frizzle. The Bowery Theatre and Astor Place Opera House basically put two completely different versions of New York within walking distance of one another.`,
    `The Bowery catered largely to working-class audiences, with melodramas, spectacle, and crowds that were LOUD. People cheered, heckled, shouted at villains, and treated the performance like something they were participating in.`,
    `Astor Place was almost the opposite. Wealthy New Yorkers went there for European opera, formal clothing, expensive seats, and apparently fewer people screaming from the pit. The building even had a dress code.`,
    `Then, two Shakespeare actors started beefing, and it was really bad.`,
    ...
    `On May 10, 1849, Macready performed Macbeth at Astor Place while thousands gathered outside. The protest turned violent, the militia arrived, and soldiers eventually fired into the crowd, killing somewhere around twenty to thirty people.`,
...
},
{
  ...
  why:"",
  body:[
    `By the 1870s, the theater world had slowly crawled north toward Union Square, where something much more recognizable as a Broadway district started forming.`,
    ...
    `Actors needed agents, productions needed costumes and scenery, somebody needed to sell tickets, producers needed places to meet performers, and restaurants were filled with theater people talking over food. Walking around Midtown today, half the neighborhood still feels indirectly connected to whatever is happening onstage somewhere nearby, and the Rialto is where that kind of environment really started.`,
    ...
    `That company became the Metropolitan Opera, which is a really funny rich-person response to the problem.`,
    ...
    `I honestly like that the origin is so messy. The Academy catches fire, a ballet troupe suddenly loses its stage, and instead of scrapping everything, people start stitching the stranded dancers and scenery into another production. And somehow this conglomeration of unlucky (or lucky) events is what made the first Musical, a staple to what American art and Broadway is today.`,
    `But to look at the grand scheme of things, Union Square shows that theater had stopped being only about actors standing onstage. At that point, Broadway was no longer just a collection of theaters. Restaurants, costume shops, producers, and performers all started relying on the same crowds, so when the people moved, the entire little world around them moved too.`,
...
},
{
  ...
  why:"",
  body:[
    `Broadway’s comeback became especially obvious during the 1990s when Disney restored the New Amsterdam Theatre and <em>The Lion King</em> arrived in 1997. Disney moving into 42nd Street was basically a cultural 180 for New York. A few decades earlier, Times Square had been associated with crime and adult theaters; now parents were walking through the same neighborhood with their children to see Simba. That is a pretty aggressive rebrand.`,
    `Going back to <em>Cats</em>, the show helped establish the megamusical model: giant productions with recognizable imagery, huge marketing campaigns, merchandise, and enough tourist appeal to keep running for years. <em>Les Misérables</em> and <em>The Phantom of the Opera</em> pushed the same idea even further. Broadway musicals is no longer something someone could see in New York by chance, instead the musical itself could become the reason they came to New York in the first place.`,
    `Linda Balgord, who became the final actress to play Grizabella in the original Broadway run of <em>Cats</em>, gives a much more human view of what Broadway actually feels like from the inside. In a 2013 <em>Playbill</em> interview, she talks about spending years hoping to make her Broadway debut before finally getting cast in <em>Passion</em>. Even then, she started in the ensemble and understudied Donna Murphy as Fosca, only going on in the lead role eighteen times. I like that detail because Broadway can seem almost mythic from the audience, but for performers it can mean years of auditions, waiting backstage, understudying, and hoping somebody gives you a chance. Balgord even remembered exactly how many times she went on because, as she joked, performers count those moments the way kids count lines in a school play (Gans).`,
    `Her career also shows that getting a major role does not automatically make Broadway glamorous. When Balgord later played Norma Desmond in the touring production of <em>Sunset Boulevard</em>, she remembered being constantly compared with bigger stars and having critics question why the tour did not have a celebrity in the lead. At the same time, she described how physically exhausting the role became after months of performing it.`,
    `Her connection to <em>Cats</em> makes the interview even more interesting to me. Balgord joined the final Broadway company as Grizabella and said that singing “Memory” meant more to her as she got older. I think that is a cool example of how a long-running musical can stay almost identical while the performer inside the role changes and what that musical means for them. For Balgord, the show was the result of years of auditions, understudying, touring, criticism, and eventually ending up in one of Broadway’s longest-running productions.`,
    `Musicals keep evolving around us. <em>Hamilton</em> came along in 2015 and proved that a huge Broadway phenomenon did not have to sound like a traditional Broadway musical at all. Lin-Manuel Miranda took the founding of the United States, cast predominantly Black and Latino actors as the Founding Fathers, and filled the score with rap, hip-hop, and R&amp;B.`,
    `My personal favorite example of that continued evolution is <em>Maybe Happy Ending</em>, which opened at the Belasco Theatre in 2024. The set design and effects were probably the coolest theatrical experience I have ever had because rooms seemed to appear and disappear, walls moved around the actors, and the whole stage felt almost cinematic and with the fact that everything was physically happening in front of you was amazing.`,
  ...
  sources:[
    {tag:"Gans", name:"Gans, Andrew. “DIVA TALK: A Chat With Now and Forever’s Linda Balgord, Star of Aspects of Love, Sunset Boulevard.” Playbill, 18 Jan. 2013. Accessed 28 July 2026.", url:"https://playbill.com/article/diva-talk-a-chat-with-now-and-forevers-linda-balgord-star-of-aspects-of-love-sunset-boulevard-com-201693"},
    {tag:"PBS", name:"PBS, Broadway: The American Musical — Resurrection of 42nd Street", url:"https://www.pbs.org/wnet/broadway/essays/resurrection-of-42nd-street/"},
